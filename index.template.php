...
echo ' <div class="time_holder"><time datetime="', smf_gmstrftime('%FT%TZ'), '">', $context['current_time'], '</time></div>';
	...
	if ($context['user']['is_logged'])
	{
		...
		echo '
					<li>', $txt['totalTimeLogged']; 
			// If days is just zero, don't bother to show it.
			if ($context['user']['total_time_logged_in']['days'] > 0)
				echo $context['user']['total_time_logged_in']['days'] . $txt['total_time_logged_days'];

			// Same with hours - only show it if it's above zero.
			if ($context['user']['total_time_logged_in']['hours'] > 0)
				echo $context['user']['total_time_logged_in']['hours'] . $txt['total_time_logged_hours'];

			// But, let's always show minutes - Time wasted here: 0 minutes ;).
			echo $context['user']['total_time_logged_in']['minutes'], $txt['total_time_logged_minutes'], '
					</li>';
					echo '
				</ul>';
	}
